...
//   void _showIOSDialog(BuildContext context, String title, String message, List<String>? buttons, String? cancelButton, Function(int)? onDone,
//       Color? positiveTitleColor, Color? cancelTitleColor, double? fontSize, bool barrierDismissible) {
...
//   void _showAndroidDialog(BuildContext context, String title, String message, List<String>? buttons, String? cancelButton, Function(int)? onDone,
//       Color? positiveTitleColor, Color? cancelTitleColor, double? fontSize, bool barrierDismissible) {
